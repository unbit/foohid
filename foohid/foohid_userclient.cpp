...
IOReturn it_unbit_foohid_userclient::_methodCreate(IOExternalMethodArguments* arguments) {
    ...
    IOMemoryDescriptor *serial_number_buf = NULL;
    IOMemoryMap *map = NULL;
    IOMemoryMap *map2 = NULL;
    IOMemoryMap *map3 = NULL;
    ...
    serial_number_buf = IOMemoryDescriptor::withAddressRange((vm_address_t) serial_number_ptr, serial_number_len, kIODirectionOut, owner);
    ...
    ptr3 = (char *)map->getAddress();
    if (!ptr3) goto nomem;
    
    ret = hid_provider->methodCreate(ptr, name_len, ptr2, descriptor_len, ptr3, serial_number_len, vendorID, productID);
